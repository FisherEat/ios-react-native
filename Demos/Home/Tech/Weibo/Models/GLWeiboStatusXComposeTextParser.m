//
//  GLWeiboStatusXComposeTextParser.m
//  Demos
//
...
@implementation GLWeiboStatusXComposeTextParser
...
- (BOOL)parseText:(NSMutableAttributedString *)text selectedRange:(NSRangePointer)selectedRange {
    ...
    
    {
        ...
        dispatch_once(&onceToken, ^{
            ...
            topicExtImages = @[
                               [GLWeiboStatusHelper imageNamed:@"timeline_card_small_movie"],
                               [GLWeiboStatusHelper imageNamed:@"timeline_card_small_book"],
                               [GLWeiboStatusHelper imageNamed:@"timeline_card_small_music"],
                               [GLWeiboStatusHelper imageNamed:@"timeline_card_small_location"],
                               [GLWeiboStatusHelper imageNamed:@"timeline_card_small_stock"]
                               ];
        });
        
        NSArray<NSTextCheckingResult *> *topicResults = [[GLWeiboStatusHelper regexTopic] matchesInString:text.string options:kNilOptions range:text.rangeOfAll];
    ...
    {
        NSArray<NSTextCheckingResult *> *atResults = [[GLWeiboStatusHelper regexAt] matchesInString:text.string options:kNilOptions range:text.rangeOfAll];
    ...
    {
        NSArray<NSTextCheckingResult *> *emoticonResults = [[GLWeiboStatusHelper regexEmoticon] matchesInString:text.string options:kNilOptions range:text.rangeOfAll];
        NSUInteger clipLength = 0;
        for (NSTextCheckingResult *emo in emoticonResults) {
            ...
            NSString *imagePath = [GLWeiboStatusHelper emoticonDic][emoString];
            UIImage *image = [GLWeiboStatusHelper imageWithPath:imagePath];
            if (!image) continue;
